                ...
                <div class="row row-with-vspace">
                    <article class="col-xs-12">
                        ...
                        <div class="example-block">
                            <h1>h1 หัวข้อ Heading <small>ข้อความย่อย Secondary text</small></h1>
                            <h2>h2 หัวข้อ Heading <small>ข้อความย่อย Secondary text</small></h2>
                            <h3>h3 หัวข้อ Heading <small>ข้อความย่อย Secondary text</small></h3>
                            <h4>h4 หัวข้อ Heading <small>ข้อความย่อย Secondary text</small></h4>
                            <h5>h5 หัวข้อ Heading <small>ข้อความย่อย Secondary text</small></h5>
                            <h6>h6 หัวข้อ Heading <small>ข้อความย่อย Secondary text</small></h6>
                        </div>
                        ...
                        <div class="example-block">
                            ...
                            <p><a href=".?<?php echo rand(0, 999); ?>">Link color</a> | <a href=".">Visited link color</a></p>
                        </div>
                        ...
                        <h2>Emphasis</h2>
                        <div class="example-block">
                            <p>Interdum et <small>malesuada (small)</small> fames ac <strong>ante</strong> ipsum primis in <em>faucibus</em>. Curabitur a nunc sit amet purus ornare adipiscing at eu orci. Vestibulum id nunc in leo blandit commodo hendrerit non leo. Nulla tristique ipsum convallis, ultrices erat sit amet, porta diam. Ut non massa gravida, gravida eros vel, pretium diam.</p>
                            <p>ไตรมาส <small>ฟรุตซังเต (small)</small>บอมบ์ซามูไรเทอร์โบรีเสิร์ช <strong>ไวกิ้ง</strong> แครอทสถาปัตย์วอล์ก<em>อยุติธรรม</em> มาร์จินซื่อบื้อเมี่ยงคำไฟลท์เรตเดี้ยง อุรังคธาตุโทร ไดเอ็ตเซ็กซ์ แจ็กพอตแช่แข็งแฟกซ์แม่ค้าเห่ย อิเหนาลิสต์ซิมเยอร์บีร่าไมค์ แคนูไฮเทคโหลนปัจเจกชนบลูเบอร์รี่ กัมมันตะราเมนนู้ดไวกิ้งติงต๊องโบตั๋น</p>
                        </div>
                        ...
                        <div class="example-block">
                            ...
                            <blockquote>
                                <p>สไลด์โดนัทละติน ธรรมาเมี่ยงคำซิมโฟนีเวณิกาไตรมาส ป๋าไตรมาสพาสเจอร์ไรส์ธรรมา</p>
