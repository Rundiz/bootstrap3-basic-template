                ...
                <div class="row row-with-vspace">
                    <article class="col-xs-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <p>
                                        ...
                                        <button type="button" class="btn btn-default btn-lg">ปุ่มใหญ่</button>
                                    </p>
                                    <p>
                                        <button type="button" class="btn btn-primary">ปุ่มกลาง</button>
                                        <button type="button" class="btn btn-default">ปุ่มกลาง</button>
                                    </p>
                                    <p>
                                        <button type="button" class="btn btn-primary btn-sm">ปุ่มเล็ก</button>
                                        <button type="button" class="btn btn-default btn-sm">ปุ่มเล็ก</button>
                                    </p>
                                    <p>
                                        <button type="button" class="btn btn-primary btn-xs">ปุ่มเล็กพิเศษ</button>
                                        <button type="button" class="btn btn-default btn-xs">ปุ่มเล็กพิเศษ</button>
                                    </p>
                                    <p>
                                        <button type="button" class="btn btn-primary btn-lg btn-block">ปุ่มระดับบล็อค</button>
                                        <button type="button" class="btn btn-default btn-lg btn-block">ปุ่มระดับบล็อค</button>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="example-block">
                            ...
                            <hr />
                            <button type="button" class="btn btn-default active">ค่าเริ่มต้น</button>
                        ...
                        <div class="example-block">
                            ...
                            <p>
                                ...
                                <button type="button" class="btn btn-default" disabled="">ค่าเริ่มต้น</button>
                            </p>
                        </div>
                    </article>
                </div>
