                ...
                <div class="row row-with-vspace">
                    <article class="col-xs-12">
                        ...
                        <div class="example-block">
                            ...
                            <div>
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-default dropdown-toggle" type="button">ปุ่มธรรมดา <span class="caret"></span></button>
                                    <ul role="menu" class="dropdown-menu">
                                ...
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" type="button">ปุ่มหลัก <span class="caret"></span></button>
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="#">การกระทำ</a></li>
                                        <li><a href="#">การกระทำอื่นๆ</a></li>
                                        <li><a href="#">อย่างอื่นๆที่นี่</a></li>
                                ...
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-success dropdown-toggle" type="button">สำเร็จ <span class="caret"></span></button>
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="#">การกระทำ</a></li>
                                        <li><a href="#">การกระทำอื่นๆ</a></li>
                                        <li><a href="#">อย่างอื่นๆที่นี่</a></li>
                                ...
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-info dropdown-toggle" type="button">ข้อมูล <span class="caret"></span></button>
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="#">การกระทำ</a></li>
                                        <li><a href="#">การกระทำอื่นๆ</a></li>
                                        <li><a href="#">อย่างอื่นๆที่นี่</a></li>
                                ...
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-warning dropdown-toggle" type="button">เตือน <span class="caret"></span></button>
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="#">การกระทำ</a></li>
                                        <li><a href="#">การกระทำอื่นๆ</a></li>
                                        <li><a href="#">อย่างอื่นๆที่นี่</a></li>
                                ...
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-danger dropdown-toggle" type="button">อันตราย <span class="caret"></span></button>
                                    <ul role="menu" class="dropdown-menu">
                                        <li><a href="#">การกระทำ</a></li>
                                        <li><a href="#">การกระทำอื่นๆ</a></li>
                                        <li><a href="#">อย่างอื่นๆที่นี่</a></li>
                        ...
                        <div class="example-block">
                            ...
                            <div>
                                <div class="btn-group">
                                    <button class="btn btn-default" type="button">ปุ่มธรรมดา</button>
                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                        <span class="caret"></span>
                                        <span class="sr-only">Toggle Dropdown</span>
                                    </button>
